...
JOBS = [
    {
        ...
        "memory": "48G",  # This is total RAM, change this accordingly to use
        "command": "python -m torch.distributed.launch --nproc_per_node=1  --use_env detr-main/main.py --resume /scratch/s203877/checkpoints/3365/checkpoint0019.pth",
